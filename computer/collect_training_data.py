...
class CollectTrainingData(object):
    ...
    # connect to a seral port
        self.ser = serial.Serial(serial_port, 8002, timeout=1)
        self.send_inst = True
    ...
    def collect(self):
        ...
        try:
            ...
            while self.send_inst:
                stream_bytes += self.connection.read(8002)
            ...
            print("Streaming duration: , %.2fs" % ((end
                                                    - start) / cv2.getTickFrequency()))
